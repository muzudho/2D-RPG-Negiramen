...
public partial class HomePage : ContentPage
{
    ...
    //    Trace.WriteLine($"[HomePage.xaml.cs ContentPage_NavigatedFrom] this.Width: {this.Width}, this.WidthRequest: {this.WidthRequest}, this.MaximumWidthRequest: {this.MaximumWidthRequest}, this.MinimumWidthRequest: {this.MinimumWidthRequest}");
    //}

    private void ContentPage_NavigatingFrom(object sender, NavigatingFromEventArgs e)
    {
        App.WidthForCollectionView = this.Width;
        Trace.WriteLine($"[HomePage.xaml.cs ContentPage_NavigatingFrom] this.Width: {this.Width}, this.WidthRequest: {this.WidthRequest}, this.MaximumWidthRequest: {this.MaximumWidthRequest}, this.MinimumWidthRequest: {this.MinimumWidthRequest}");
    }
    ...
    {
        // Trace.WriteLine($"[HomePage.xaml.cs TileCropButton_Clicked] sender.GetType().FullName: {sender.GetType().FullName}");
        // [HomePage.xaml.cs TileCropButton_Clicked] sender.GetType().FullName: Microsoft.Maui.Controls.Button
        ...
        await CodeBehindHelper.ReadyGoToNext(
            onOk: async () =>
            {
                ...
                Trace.WriteLine($"[HomePage.xaml.cs TileCropButton_Clicked] stilesetImageFile: {tilesetImageFile.Path.AsStr}, tilesetSettingsFile: {tilesetSettingsFile.Path.AsStr}");
