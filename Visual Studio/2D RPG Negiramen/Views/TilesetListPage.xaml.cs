...
public partial class TilesetListPage : ContentPage
{
    ...
    async void RenameFileNameToUUIDButton_Clicked(object sender, EventArgs e)
    {
        ...
        try
        {
            var oldTilesetTomlLocation = App.GetOrLoadProjectConfiguration().UnityAssetsFolderLocation.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder.CreateTilesetToml(context.SelectedFileStemAsStr);
            if (oldTilesetTomlLocation.IsExists())
            {
                var newTilesetTomlLocation = App.GetOrLoadProjectConfiguration().UnityAssetsFolderLocation.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder.CreateTilesetToml(uuid.AsStr);
    ...
    async void TilesetDeleteButton_Clicked(object sender, EventArgs e)
    {
        ...
        if (result == keyword)
        {
            ...
            try
            {
                var tilesetTomlLocation = App.GetOrLoadProjectConfiguration().UnityAssetsFolderLocation.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder.CreateTilesetToml(context.SelectedFileStemAsStr);
