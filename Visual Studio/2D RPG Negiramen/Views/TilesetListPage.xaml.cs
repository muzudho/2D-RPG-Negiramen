...
public partial class TilesetListPage : ContentPage
{
    ...
    private void ContentPage_Loaded(object sender, EventArgs e)
    {
        ...
        // タイルセット画像が入っているフォルダーを取得
        var tilesetFolder = App.GetOrLoadConfiguration().UnityAssetsFolder.YourCircleNameFolder.YourWorkNameFolder.AutoGeneratedFolder.ImagesFolder.TilesetFolder;

        // フォルダーの中の PNG画像ファイルを一覧
        foreach(var path in System.IO.Directory.GetFiles(tilesetFolder.Path.AsStr, "*.png"))
        {
            Trace.WriteLine($"[TilesetListPage.xaml.cs ContentPage_Loaded] path: [{path}]");
        }
    }
    #endregion
