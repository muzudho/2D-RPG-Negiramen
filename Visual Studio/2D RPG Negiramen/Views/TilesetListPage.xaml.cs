...
public partial class TilesetListPage : ContentPage
{
            ...
            isNew: out bool isNew))
        {
            ...
            if (isNew)
            {
                ...
                if (oldFileStem != null && !UUIDHelper.IsMatch(oldFileStem.AsStr))
                {
                    ...
                    var tilesetLocalConfigurationLocation = App.GetOrLoadProjectConfiguration().UnityAssetsFolderLocation.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder.LocalesFolder.CreateSelectedLocaleFolder().CreateTilesetLocalToml(tilesetOriginalPngFileStem);
                    ...
                    if (TilesetLocalConfiguration.SaveTOML(
                        ...
                        difference: configurationBuffer,
    ...
    async void RenameFileNameToUUIDButton_Clicked(object sender, EventArgs e)
    {
        ...
        try
        {
            var oldTilesetTomlLocation = App.GetOrLoadProjectConfiguration().UnityAssetsFolderLocation.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder.CreateTilesetGlobalToml(FileStem.FromString(context.SelectedFileStemAsStr));
    ...
    async void TilesetDeleteButton_Clicked(object sender, EventArgs e)
    {
        ...
        if (result == keyword)
        {
            ...
            try
            {
                var tilesetTomlLocation = App.GetOrLoadProjectConfiguration().UnityAssetsFolderLocation.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder.CreateTilesetGlobalToml(FileStem.FromString(context.SelectedFileStemAsStr));
