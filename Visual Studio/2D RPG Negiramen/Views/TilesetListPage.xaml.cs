...
public partial class TilesetListPage : ContentPage
{
    ...
    private void ContentPage_Loaded(object sender, EventArgs e)
    {
        ...
        var tilesetFolder = App.GetOrLoadConfiguration().UnityAssetsFolder.YourCircleFolderNameFolder.YourWorkFolderNameFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder;
        ...
        foreach (var originalPngPathAsStr in System.IO.Directory.GetFiles(tilesetFolder.Path.AsStr, "*.png"))
        {
            ...
            var task = Task.Run(async () =>
            {
                ...
                {
                    // 出力先ディレクトリーが無ければ作成する
                    var outputFolder = App.CacheFolder.YourCircleFolderNameFolder.YourWorkFolderNameFolder.ImagesFolder.TilesetFolder.ImagesTilesetsThumbnailsFolder;
