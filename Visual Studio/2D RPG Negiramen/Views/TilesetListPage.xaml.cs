...
public partial class TilesetListPage : ContentPage
{
    ...
    async void TilesetDeleteButton_Clicked(object sender, EventArgs e)
    {
        ...
        if (result == keyword)
        {
            ...
            try
            {
                var tilesetPngLocation = App.GetOrLoadProjectConfiguration().UnityAssetsFolder.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder.CreateTilesetPng(context.SelectedFileStem);
                ...
                if (tilesetPngLocation.Path.AsStr.Contains(App.GetOrLoadConfiguration().CurrentYourCircleFolderName.AsStr) &&
                    ...
                    tilesetPngLocation.Path.AsStr.Contains(context.SelectedFileStem))
                {
            ...
            try
            {
                var tilesetTomlLocation = App.GetOrLoadProjectConfiguration().UnityAssetsFolder.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder.CreateTilesetToml(context.SelectedFileStem);
                ...
                if (tilesetTomlLocation.Path.AsStr.Contains(App.GetOrLoadConfiguration().CurrentYourCircleFolderName.AsStr) &&
                    ...
                    tilesetTomlLocation.Path.AsStr.Contains(context.SelectedFileStem))
                {
