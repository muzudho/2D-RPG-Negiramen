            ...
            isNew: out bool isNew))
        {
            ...
            if (isNew)
            {
                ...
                if (oldFileStem != null && !UUIDHelper.IsMatch(oldFileStem.AsStr))
                {
                    ...
                    var tilesetLocalConfigurationLocation = App.GetOrLoadProjectConfiguration().UnityAssetsFolderLocation.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder.LocalesFolder.CreateSelectedLocaleFolder().CreateTilesetLocalToml(fileStem);
