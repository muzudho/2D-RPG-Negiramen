...
public partial class TilesetListPage : ContentPage
{
    ...
    async void RenameFileNameToUUIDButton_Clicked(object sender, EventArgs e)
    {
        ...
        try
        {
            var oldTilesetTomlLocation = App.GetOrLoadProjectConfiguration().UnityAssetsFolder.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder.CreateTilesetToml(context.SelectedFileStemAsStr);
            if (oldTilesetTomlLocation.IsExists())
            {
                var newTilesetTomlLocation = App.GetOrLoadProjectConfiguration().UnityAssetsFolder.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder.CreateTilesetToml(uuid.AsStr);
        ...
        var oldTilesetPngLocation = App.GetOrLoadProjectConfiguration().UnityAssetsFolder.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder.CreateTilesetPng(context.SelectedFileStemAsStr);
        var newTilesetPngLocation = App.GetOrLoadProjectConfiguration().UnityAssetsFolder.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder.CreateTilesetPng(uuid.AsStr);
    ...
    async void TilesetDeleteButton_Clicked(object sender, EventArgs e)
    {
        ...
        if (result == keyword)
        {
            ...
            try
            {
                var tilesetPngLocation = App.GetOrLoadProjectConfiguration().UnityAssetsFolder.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder.CreateTilesetPng(context.SelectedFileStemAsStr);
            ...
            try
            {
                var tilesetTomlLocation = App.GetOrLoadProjectConfiguration().UnityAssetsFolder.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder.CreateTilesetToml(context.SelectedFileStemAsStr);
