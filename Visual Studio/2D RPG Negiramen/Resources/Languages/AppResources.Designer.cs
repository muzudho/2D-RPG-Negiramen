...
namespace _2D_RPG_Negiramen.Resources.Languages {
    ...
    internal class AppResources {
        ...
        /// <summary>
        ///   このフォルダーの下は自動編集されます に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   Unity の Assets フォルダ―へ足りてないファイルを転送 に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   あなたがローカルＰＣへダウンロードした 2D RPG Negiramen に含まれる Workspace フォルダーへのパス に類似しているローカライズされた文字列を検索します。
        /// </summary>
