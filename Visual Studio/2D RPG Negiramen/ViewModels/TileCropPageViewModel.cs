namespace _2D_RPG_Negiramen.ViewModels
{
    ...
    class TileCropPageViewModel : ObservableObject, ITileCropPageViewModel
    {
        ...
        ///     </list>
        /// </summary>
        public TileRecordVisualBuffer CropCursorPointedTileRecordVisualBuffer
        {
            get => this.cropCursorPointedTileRecordVisualBuffer;
            set
            {
                // 値に変化がない
                if (this.cropCursorPointedTileRecordVisualBuffer == value)
                    return;

                if (value.IsNone)
                {
                    if (this.cropCursorPointedTileRecordVisualBuffer.IsNone)
                    {
                    ...
                    else
                    {
                        ...
                        // 空にする
                        this.cropCursorPointedTileRecordVisualBuffer = TileRecordVisualBuffer.CreateEmpty();
                    }
                }
                else
                {
        ...
        public Models.TileIdOrEmpty SelectedTileIdOrEmpty
        {
            get
            {
                ...
                return this.cropCursorPointedTileRecordVisualBuffer.Id;
            }
            set
            {
                if (this.cropCursorPointedTileRecordVisualBuffer.IsNone)
                {
                    ...
                    // タイルＩｄだけ持っておく
                    this.cropCursorPointedTileRecordVisualBuffer = TileRecordVisualBuffer.FromModel(
                ...
                {
                    var contents = this.cropCursorPointedTileRecordVisualBuffer;
        ...
        public int SourceCroppedCursorLeftAsInt
        {
            get
            {
                ...
                return this.cropCursorPointedTileRecordVisualBuffer.SourceRectangle.Location.X.AsInt;
            }
            set
            {
                if (this.cropCursorPointedTileRecordVisualBuffer.IsNone)
        ...
        public int SourceCroppedCursorTopAsInt
        {
            get
            {
                ...
                return this.cropCursorPointedTileRecordVisualBuffer.SourceRectangle.Location.Y.AsInt;
            }
            set
            {
                if (this.cropCursorPointedTileRecordVisualBuffer.IsNone)
                {
                    ...
                    cropCursorPointedTileRecordVisualBuffer = TileRecordVisualBuffer.FromModel(
                        tileRecord: new Models.TileRecord(
                            id: Models.TileIdOrEmpty.Empty,
                            rect: rect1,
                            title: Models.TileTitle.Empty,
        ...
        public Models.Geometric.SizeInt SourceCroppedCursorSize
        {
            get
            {
                ...
                return this.cropCursorPointedTileRecordVisualBuffer.SourceRectangle.Size;
            }
            set
            {
                if (this.cropCursorPointedTileRecordVisualBuffer.IsNone)
        ...
        public int SourceCroppedCursorWidthAsInt
        {
            get
            {
                ...
                return this.cropCursorPointedTileRecordVisualBuffer.SourceRectangle.Size.Width.AsInt;
            }
            set
            {
                if (this.cropCursorPointedTileRecordVisualBuffer.IsNone)
        ...
        public int SourceCroppedCursorHeightAsInt
        {
            get
            {
                ...
                return this.cropCursorPointedTileRecordVisualBuffer.SourceRectangle.Size.Height.AsInt;
            }
            set
            {
                if (this.cropCursorPointedTileRecordVisualBuffer.IsNone)
        ...
        public string SelectedTileIdAsBASE64
        {
            get
            {
                ...
                return this.cropCursorPointedTileRecordVisualBuffer.Id.AsBASE64;
            }
        }
        ...
        public string SelectedTileIdAsPhoneticCode
        {
            get
            {
                ...
                return this.cropCursorPointedTileRecordVisualBuffer.Id.AsPhoneticCode;
            }
        }
        ...
        ///     </list>
        /// </summary>
        public bool IsEnabledSelectedTileTitleAsStr => !this.cropCursorPointedTileRecordVisualBuffer.IsNone && !this.SelectedTileIdOrEmpty.IsEmpty;
        ...
        public string SelectedTileTitleAsStr
        {
            get
            {
                return this.cropCursorPointedTileRecordVisualBuffer.Title.AsStr;
            }
            set
            {
                if (this.cropCursorPointedTileRecordVisualBuffer.IsNone)
        ...
        public string AddsButtonHint
        {
            get
            {
                ...
                if (this.cropCursorPointedTileRecordVisualBuffer.Id == Models.TileIdOrEmpty.Empty)
                {
                    // 未選択時
                    return "選択タイルを、タイル一覧画面へ追加";
                }
        ...
        public void AddRegisteredTile()
        {
            ...
            var cropCursorVisualBuffer = this.CropCursorPointedTileRecordVisualBuffer;
        ...
        internal void LoadCroppedCursorPointedTile()
        {
            this.TilesetSettingsVM.MatchByRectangle(
                ...
                some: (tileRecordVisualBuffer) =>
                {
                    ...
                    // 選択中のタイルを設定
                    this.CropCursorPointedTileRecordVisualBuffer = tileRecordVisualBuffer;
                },
                none: () =>
                {
        ...
        ///     </list>
        /// </summary>
        TileRecordVisualBuffer cropCursorPointedTileRecordVisualBuffer = TileRecordVisualBuffer.CreateEmpty();
