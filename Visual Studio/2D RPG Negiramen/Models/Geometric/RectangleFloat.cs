namespace _2D_RPG_Negiramen.Models.Geometric
{
    ...
    public class RectangleFloat
    {
        ...
        ///     空オブジェクト
        /// </summary>
        internal static RectangleFloat Empty = new(PointFloat.Empty, SizeFloat.Zero);
        #endregion
        ...
        internal RectangleFloat Multiplicate(Zoom zoom)
        {
            return new RectangleFloat(
                location: this.Location.Multiplicate(zoom),
                size: this.Size.Multiplicate(zoom));
        }
        #endregion
    }
}
