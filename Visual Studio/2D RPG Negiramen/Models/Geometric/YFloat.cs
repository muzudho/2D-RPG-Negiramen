namespace _2D_RPG_Negiramen.Models.Geometric
{
    ...
    internal class YFloat
    {
        ...
        /// <returns>そうだ</returns>
        public static bool operator ==(YFloat c1, YFloat c2)
        {
        ...
        public int CompareTo(object other)
        {
            ...
            return source.CompareTo(((YFloat)other).source);
        }
        ...
        ///     ゼロ・オブジェクト
        /// </summary>
        internal static YFloat Zero = new(0);
        #endregion
        ...
        internal YFloat Multiplicate(Zoom zoom)
        {
