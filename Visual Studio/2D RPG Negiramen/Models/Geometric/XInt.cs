namespace _2D_RPG_Negiramen.Models.Geometric
{
    ...
    internal class XInt
    {
        ...
        /// <returns>そうだ</returns>
        public static bool operator ==(XInt c1, XInt c2)
        {
        ...
        public int CompareTo(object other)
        {
            ...
            return source.CompareTo(((XInt)other).source);
        }
        ...
        /// </summary>
        /// <returns>変換後</returns>
        internal XFloat ToFloat()
        {
            return new XFloat(this.source);
        }
        #endregion
