namespace _2D_RPG_Negiramen.Models.FileEntries
{
    ...
    internal class UnityAssetsDeployment
    {
        ...
        static void PushStartupMemberToYourCircleFolder(TheLocationOfUnityAssets.YourCircleFolder yourCircleFolder)
        {
            // 無ければ作成
        ...
        static void PushStartupMemberToYourWorkFolder(TheLocationOfUnityAssets.YourWorkFolder yourWorkFolder)
        {
            // 無ければ作成
