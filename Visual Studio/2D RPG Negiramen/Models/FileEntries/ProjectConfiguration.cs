...
";
    ...
    internal bool IsReady()
    {
        ...
        bool isStarterKitFolderExists = this.StarterKitFolder.IsDirectoryExists();

        // Unity の Auto Generated フォルダーが存在する
        bool isUnityAssetsAutoGeneratedFolderExists = this.UnityAssetsFolder.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.IsDirectoryExists();
