namespace _2D_RPG_Negiramen.Models.FileEntries.Locations.UnityAssets
{
    ...
    ///     </list>
    /// </summary>
    internal class PrefabsFolder : Its
    {
        // - その他
        ...
        ///     生成
        /// </summary>
        internal PrefabsFolder(FileEntryPathSource pathSource, Lazy.Convert<FileEntryPathSource, FileEntryPath> convert)
