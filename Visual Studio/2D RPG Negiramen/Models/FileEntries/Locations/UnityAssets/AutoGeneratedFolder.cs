...
///     </list>
/// </summary>
class AutoGeneratedFolder : ItsFolder
{
    // - その他
    ...
    /// </summary>
    internal TheFileEntryLocations.UnityAssets.Images.ItsFolder ImagesFolder
    {
        get
        {
            if (imagesFolder == null)
            {
                imagesFolder = new TheFileEntryLocations.UnityAssets.Images.ItsFolder(Path);
            }
    ...
    TheFileEntryLocations.UnityAssets.Images.ItsFolder? imagesFolder;
