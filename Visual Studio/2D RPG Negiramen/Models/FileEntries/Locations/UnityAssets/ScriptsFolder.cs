...
///     </list>
/// </summary>
internal class ScriptsFolder : ItsFolder
{
    // - その他
    ...
    ///     生成
    /// </summary>
    internal ScriptsFolder(FileEntryPath parentPath)
        : base(pathSource: FileEntryPathSource.FromString(System.IO.Path.Combine(parentPath.AsStr, "Scripts")),
