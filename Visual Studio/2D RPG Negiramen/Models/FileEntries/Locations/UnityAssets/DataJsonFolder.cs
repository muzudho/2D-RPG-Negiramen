...
///     </list>
/// </summary>
internal class DataJsonFolder : ItsFolder
{
    // - その他
    ...
    ///     生成
    /// </summary>
    internal DataJsonFolder(FileEntryPath parentPath)
        : base(pathSource: FileEntryPathSource.FromString(System.IO.Path.Combine(parentPath.AsStr, "JSON")),
