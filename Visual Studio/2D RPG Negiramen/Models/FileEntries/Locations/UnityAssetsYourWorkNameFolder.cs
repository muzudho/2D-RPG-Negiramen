namespace _2D_RPG_Negiramen.Models.FileEntries.Locations
{
    ...
    internal class UnityAssetsYourWorkNameFolder : Its
    {
        ...
        internal UnityAssetsAutoGeneratedFolder AutoGeneratedFolder
        {
            get
            {
                if (unityAssetsAutoGeneratedFolder == null)
                {
                    unityAssetsAutoGeneratedFolder = new UnityAssetsAutoGeneratedFolder(
                ...
                return unityAssetsAutoGeneratedFolder;
            }
        }
        #endregion
        ...
        UnityAssetsAutoGeneratedFolder unityAssetsAutoGeneratedFolder;
    }
}
