...
internal class TilesetGlobalConfiguration
{
        ...
        out TilesetGlobalConfiguration? newConfiguration)
    {
        ...
        var tilesetGlobalConfigurationLocation = App.GetOrLoadProjectConfiguration().UnityAssetsFolderLocation.YourCircleFolder.YourWorkFolder.AutoGeneratedFolder.ImagesFolder.TilesetsFolder.CreateTilesetToml(fileStem);
